...
import { ActivityTimeline, RunsUnsupportedNote, ago } from "../components/activity-feed.js";
...
/**
 * The unified three-signal activity feed: needs-review pinned on top, then the
 * shared timeline (filter chips, day groups, quiet collapse) with repo badges.
 */
function ActivityFeedCard({
  ...
  return (
    <Card className="mb-4 overflow-hidden">
      ...
      <ActivityTimeline items={feed ? items : null} showRepo />
